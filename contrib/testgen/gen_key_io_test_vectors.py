...
bech32_templates = [
  ...
  ('ubqt',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('ubqt',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('ubqt',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tubqt',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tubqt',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tubqt',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rubqt',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rubqt',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rubqt', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tubqt',  17, 32, False, False, False),
  ('rubqt',  3,  1, False, False, False),
  ('ubqt',   15, 41, False, False, False),
  ('tubqt',  0, 16, False, False, False),
  ('rubqt',  0, 32, True,  False, False),
  ('ubqt',   0, 16, True,  False, False),
  ('tubqt',  0, 32, False, True,  False),
  ('rubqt',  0, 20, False, False, True)
]

...
class ScriptAddress2Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(multisig_addr[0], 'Y')
        ...
        priv_keys = ["cU7eeLPKzXeKMeZvnEJhvZZ3tLqVF3XGeo1BbM8dnbmV7pP3Yg89",
        ...
        assert_equal(multisig_addr_new, 'YZ974ZrPrmqMmm1PSVp4m8YEgo3bCYZBbe')
        multisig_addr_old = "2N5nLwYz9qfnGdaFLpPn3gS6oYYbmLTWPjq"
